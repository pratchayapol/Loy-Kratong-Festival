...
<body x-data="{}"
    class="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100 font-display overflow-hidden">
    ...
    <main class="relative min-h-screen">
        ...
        <div
            class="absolute top-[8%] right-[10%] w-16 h-16 sm:w-20 sm:h-20 rounded-full 
                ...
                animate-moonGlow pointer-events-none z-10 opacity-90">
        </div>
        ...
        <div class="pointer-events-none absolute inset-0" x-data="{ stars: [] }" x-init="for (let i = 0; i < 120; i++) {
            stars.push({
    ...
    <script>
        ...
        function riverScene(types, recent) {
            ...
            const makeStyle = (dur, delay, top) => {
                ...
                sheet.insertRule(
                    `@keyframes ${name}{0%{left:-15%;opacity:0}3%{opacity:1}97%{opacity:1}100%{left:115%;opacity:0}}`,
