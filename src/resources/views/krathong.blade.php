...
@section('content')
    ...
    <div class="fixed right-4 top-4 z-40 flex flex-col gap-3 items-end">
        ...
        <!-- กล่องแชร์พื้นหลังขาว -->
        <div
            class="bg-white/95 backdrop-blur px-3 py-3 rounded-2xl shadow-lg border border-slate-200 flex flex-col gap-2 w-48 sm:w-auto">

            <!-- label -->
            <div class="flex items-center gap-2 text-slate-700 text-sm font-semibold">
                <span
                    class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-slate-900 text-white text-xs">↗</span>
                <span>แชร์</span>
            </div>

            <!-- ปุ่มแชร์ -->
            <div class="flex flex-col sm:flex-row gap-2 justify-end sm:items-center">
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode($shareUrl ?? url()->current()) }}"
                    ...
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-2xl
                      ...
                      shadow hover:shadow-md hover:brightness-110
