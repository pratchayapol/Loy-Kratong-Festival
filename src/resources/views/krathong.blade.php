...
<head>
    ...
    <style>
        ...
        .ripple .ring.r2 {
            animation-delay: calc(var(--rippleDur, 3.6s)/2);
            opacity: .25
        }
...
<body x-data="{}" class="min-h-screen bg-slate-950 text-slate-100 font-display overflow-hidden">
    ...
    <main class="relative min-h-screen">
        ...
        <div class="absolute top-0 left-0 right-0 h-[42%]">
            ...
            <!-- พระจันทร์ที่สวยงาม -->
            <div
                class="absolute top-[18%] right-[10%] w-16 h-16 sm:w-24 sm:h-24 rounded-full 
            ...
            <div
                class="absolute top-[18%] right-[10%] w-1 sm:w-1.5 h-[50vh] opacity-8 
                  bg-gradient-to-b from-yellow-100/30 via-yellow-50/10 to-transparent 
                  blur-xl transform rotate-[8deg] pointer-events-none">
            </div>
            ...
            <div class="pointer-events-none absolute inset-0" x-data="{ shooting: [] }" x-init="const addStar = () => {
        ...
        <div class="absolute left-0 right-0 top-[42%] bottom-0 overflow-hidden">
            ...
            <!-- คลื่นพื้นผิว -->
            <div
                class="absolute left-0 w-[220%] h-28 top-[10%] opacity-28 blur-2xl bg-[radial-gradient(ellipse_at_center,_rgba(255,255,255,.9)_0%,_transparent_60%)] animate-[waves_28s_linear_infinite]">
            </div>
            <div
                class="absolute left-0 w-[220%] h-28 top-[40%] opacity-20 blur-2xl bg-[radial-gradient(ellipse_at_center,_rgba(255,255,255,.85)_0%,_transparent_60%)] animate-[waves_34s_linear_infinite]">
            </div>
            <div
                class="absolute left-0 w-[220%] h-28 top-[70%] opacity-16 blur-2xl bg-[radial-gradient(ellipse_at_center,_rgba(255,255,255,.8)_0%,_transparent_60%)] animate-[waves_40s_linear_infinite]">
            </div>
                       ...
                       transition-all duration-300 p-3 sm:p-4 flex flex-col items-center gap-2"
                                    ...
                                    <span class="absolute -top-2 -right-2 transition-all duration-200"
                                        :class="form.type === '{{ $key }}' ? 'scale-100 opacity-100' :
                                            'scale-0 opacity-0'">
                                        <span
                                            class="w-6 h-6 rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 
    ...
    <script>
        ...
        // กันค้างเมื่อรีเฟรช: ล้าง timer ทั้งหมด
